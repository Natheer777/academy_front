...
export default function Register_account() {
  ...
  return (
    ...
    <div className="register_half container col-lg-5">
        <div className=''>

        <img className='m-auto d-flex' src={register_img} alt="" />
        <p className=' m-auto d-flex '>قم بتعبئة نموذج التسجيل باستخدام بريدك الإلكتروني أو حسابات التواصل الاجتماعي. بعد ذلك، ستتلقى رسالة تأكيد بالبريد الإلكتروني.</p>
        </div>
      </div>
  ...
  <form className="form-container academy p-5 mt-5 mb-5 m-auto" onSubmit={handleSubmit}>
    ...
    <div>
      <label>الاسم الشخصي: <span style={{ color: 'red' }}>*</span></label>
    ...
    <div>
      <label>دولة الإقامة: <span style={{ color: 'red' }}>*</span></label>
      <input type="text" name="country" value={formData.country} onChange={handleChange} required />
    </div>
    
    <div>
      <label>العمر: <span style={{ color: 'red' }}>*</span></label>
    ...
    <div>
      <label>المستوى التعليمي: <span style={{ color: 'red' }}>*</span></label>
    ...
    <div>
      ...
      <input type="text" name="japaneseLevel" value={formData.japaneseLevel} onChange={handleChange} />
    </div>
    
    <div>
      <label>رقم الواتساب: <span style={{ color: 'red' }}>*</span></label>
